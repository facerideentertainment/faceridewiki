...
import { app as firebaseApp, auth, firestore, functions, analytics as analyticsPromise } from '@/firebase';
...
export const FirebaseProvider: React.FC<FirebaseProviderProps> = ({
  ...
  useEffect(() => {
    analyticsPromise.then(setAnalytics);
  }, []);
